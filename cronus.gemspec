...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG", "LICENSE", "README.rdoc", "lib/cronus.rb", "lib/cronus/symbols.rb"]
  s.files = ["CHANGELOG", "Gemfile", "Gemfile.lock", "cronus.gemspec", "LICENSE", "Manifest", "README.rdoc", "Rakefile", "assets/scripts/coffee/library.coffee", "config/assets.rb", "lib/cronus.rb", "lib/cronus/symbols.rb", "spec/jasmine.yml", "spec/support/classes.coffee", "spec/support/helpers.coffee", "spec/support/mocks.coffee", "spec/support/objects.coffee", "spec/support/requirements.coffee"]
